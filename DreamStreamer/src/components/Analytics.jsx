...
const Analytics = () => {
	...
	// Handle errors in a consolidated manner
	...
	return (
		<div className="p-4">
			<h1 className="text-white text-3xl mb-3 mt-3 font-bold">
				Click Analytics
			</h1>
			<div className="flex flex-row items-end justify-end mb-5 mr-20">
				<details className="dropdown">
					<summary
						...
						className="btn m-1 bg-white hover:bg-white hover:text-black  text-black"
					>
						Time Range
					</summary>
					<ul className="menu dropdown-content bg-white rounded-box z-[1] w-52 p-2 shadow">
						<li className="bg-white text-black" value="daily">
							<a>Daily</a>
						</li>
						<li className="bg-white text-black" value="monthly">
							<a>Monthly</a>
						</li>
						<li className="bg-white text-black" value="yearly">
							<a>Yearly</a>
						</li>
					</ul>
				</details>
        ...
        <tbody>
          {clickData.map((data, index) => (
            <tr key={index}>
              <td className="px-4 py-2">{data.entity_type}</td>
              <td className="px-4 py-2">{data.name}</td>
              <td className="px-4 py-2">{data.click_count}</td>
            </tr>
          ))}
        </tbody>
      </table>
*/}
			...
			<ul>
				{topSongs.map((song, index) => (
					<li key={index}>
						{song.track_name} - {song.total_streams} streams
					</li>
				))}
			</ul>
		</div>
